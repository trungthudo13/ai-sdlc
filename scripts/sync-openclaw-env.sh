...
if [[ -f "$target_file" ]]; then
  awk '
    BEGIN { managed = "^(AI_SDLC_POSTGRES_URL|AI_SDLC_QDRANT_API_KEY|AI_SDLC_QDRANT_COLLECTION|AI_SDLC_QDRANT_DISTANCE|AI_SDLC_QDRANT_EMBEDDING_DIMENSION|AI_SDLC_QDRANT_EMBEDDING_MODEL|AI_SDLC_QDRANT_URL|AI_SDLC_OPENAI_API_KEY)=" }
